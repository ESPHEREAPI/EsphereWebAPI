 ...
 */
@Entity
@Table(name = "ORCLASS_GEST_COMP_AGEN", uniqueConstraints = @UniqueConstraint(columnNames = {"ID_ENTREPRISE","ID_GEST_STOCK", "DATE_EFFET", "ID_OPER_STOCK", "ID_NAT_DOC", "ID_TYPE_DOC", "ID_INTERMEDIAIRE"}))
public class OrclassGestionCompagnieAgence implements DAOEntry {

    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @NotNull
    @Column(name = "ID_GEST_COAGEN")
    private Long id;

    @JoinColumn(name = "ID_ENTREPRISE", referencedColumnName = "ID_ENTREPRISE")
    @ManyToOne(optional = false)
    private OrclassEntreprises idEntreprise;
    @JoinColumn(name = "ID_GEST_STOCK", referencedColumnName = "ID_GEST_STOCK")
    @ManyToOne(optional = false)
    private OrclassGestionStockCompagnie idGestionStockCompagnie;
    ...
    public OrclassGestionCompagnieAgence() {
        idGestionStockCompagnie = new OrclassGestionStockCompagnie();
    ...
    public OrclassGestionStockCompagnie getIdGestionStockCompagnie() {
        return idGestionStockCompagnie;
    }

    public void setIdGestionStockCompagnie(OrclassGestionStockCompagnie idGestionStockCompagnie) {
        this.idGestionStockCompagnie = idGestionStockCompagnie;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OrclassGestionCompagnieAgence)) {
            return false;
        }
        OrclassGestionCompagnieAgence other = (OrclassGestionCompagnieAgence) object;
    ...
    public String toString() {
        return "modele.OrclassGestionCompagnieAgence[ id=" + id + " ]";
    }
