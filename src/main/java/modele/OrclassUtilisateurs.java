...
@Entity
//@MappedSuperclass
@Table(name = "ORCLASS_UTILISATEURS")
//@XmlRootElement
...
//    private String telephone;
    ...
    private List<OrclassRoless> orclassRolessList;
    @ManyToMany(mappedBy = "orclassUtilisateursList")
    ...
    @XmlTransient
    public List<OrclassRoless> getOrclassRolessList() {
        return orclassRolessList;
    }

    public void setOrclassRolessList(List<OrclassRoless> orclassRolessList) {
        this.orclassRolessList = orclassRolessList;
    }
