...
//    @ManyToOne(optional = true)
  ...
  HashMap<Long, List[]> mapForObjetGroupe = new HashMap<Long, List[]>();
    ...
    public OrclassPolicePlafond getPolicePlafond() {
        return policePlafond;
    }

    public void setPolicePlafond(OrclassPolicePlafond policePlafond) {
        this.policePlafond = policePlafond;
    }

    public int getIndice_tab2() {
        return indice_tab2;
    }

    public void setIndice_tab2(int indice_tab2) {
        this.indice_tab2 = indice_tab2;
    }
