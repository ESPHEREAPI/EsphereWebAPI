...
//  logo de l entreprise
    ...
    private List<OrclassClasses> orclassClassesList;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "idEntreprise")
    private List<OrclassBranches> orclassBranchesList;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "idEntreprise")
    private List<OrclassGroupes> orclassGroupesList;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "orclassEntreprises")
...
//    private int compte;
    ...
    @XmlTransient
    public List<OrclassClasses> getOrclassClassesList() {
        return orclassClassesList;
    }

    public void setOrclassClassesList(List<OrclassClasses> orclassClassesList) {
        this.orclassClassesList = orclassClassesList;
    }
    ...
    @XmlTransient
    public List<OrclassGroupes> getOrclassGroupesList() {
        return orclassGroupesList;
    }

    public void setOrclassGroupesList(List<OrclassGroupes> orclassGroupesList) {
        this.orclassGroupesList = orclassGroupesList;
    }
