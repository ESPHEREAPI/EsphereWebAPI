...
import dao.OrclassTypeQuitanceDao;
...
public class ConfigInitialBean implements IInitializeDB {
    ...
    @EJB
    private ReligionDao religionsdao;
    @EJB
    ...
    @EJB
    OrclassEntreprisesDao entrepriseDao;
    @EJB
...
//            }
    ...
    public void addProfileAdmin() {
        ...
        Collection<OrclassProfilsAcces> colPA = new ArrayList<>();
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    @Override
    public OrclassEntreprises createCompagnieUtilisateurSysteme() {
        OrclassEntreprises compagnie = null;
        if (entrepriseDao.findEntityHavingValue("code", "0000") == null) {
            compagnie = new OrclassEntreprises();
            compagnie.setCode("0000");
            compagnie.setRaisonSociale("GLOBALCOMPAGNIE");
            compagnie.setResponsable("Utilisateur systeme");
            compagnie.setDateCreation(new Date());
            compagnie.setImmatriculation("00000000");
            compagnie.setNoContribuable("000000");
            entrepriseDao.create(compagnie);
            ...
            for (OrclassUtilisateurs user : userDao.findAllEntitiesHavingValue("typeUtilisateur", TypeUtilisateur.UTILISATEUR_SYSTEM)) {
                user.setIdEntreprise(compagnie);
                userDao.update(user);
            }
        }
        return compagnie;
