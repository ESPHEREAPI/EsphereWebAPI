...
//    public void insertUserInLogger(Personne u);
    ...
    public String addRegistreProduction(OrclassRegistreProduction pr, OrclassCategories cat, OrclassEntreprises e) throws GlobalException;

    public void addPlafondMaladie(OrclassPlafondMaladie pm, List<OrclassRubriquePrestation> listSelectedRubriquePrestation, OrclassDetailPlafondMaladie dpm, OrclassEntreprises e) throws GlobalException;
