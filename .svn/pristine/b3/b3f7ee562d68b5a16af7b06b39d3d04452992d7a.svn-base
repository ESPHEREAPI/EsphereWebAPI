...
public class OrclassSinistre implements DAOEntry {
    ...
    @JoinColumn(name = "ID_REG_SIN", referencedColumnName = "ID_REG_SIN")
    @ManyToOne(optional = false)
    ...
    private String devalider_par;

       @Column(name = "DATE_DEVALIDE")
    @Temporal(TemporalType.TIMESTAMP)
    private Date date_devalider;
    ...
    private Boolean remboursement_maladie=Boolean.FALSE;
     private Boolean valide_pec=Boolean.FALSE;
    ...
    public Boolean getValide_pec() {
        return valide_pec;
    }

    public void setValide_pec(Boolean valide_pec) {
        this.valide_pec = valide_pec;
    }
    ...
    public String getDevalider_par() {
        return devalider_par;
    }

    public void setDevalider_par(String devalider_par) {
        this.devalider_par = devalider_par;
    }

    public Date getDate_devalider() {
        return date_devalider;
    }

    public void setDate_devalider(Date date_devalider) {
        this.date_devalider = date_devalider;
    }
